          ...
          <div className="panel panel-yellow">
            <div className="panel-heading">
              <div className="row">
                ...
                <div className="col-xs-8 text-right">
                  <div className="huge">{dashboardSummary.monthlyCalled}</div>
                  <div>נקרא החודש</div>
                </div>
              </div>
            </div>
          ...
          <div className="panel panel-red">
            <div className="panel-heading">
              <div className="row">
                ...
                <div className="col-xs-8 text-right">
                  <div className="huge">{dashboardSummary.monthlyUnCalled}</div>
                  <div>לא נקרא החודש</div>
                </div>
              </div>
            </div>
            <a href="#">
                    ...
                    <div className="timeline-heading">
                      ...
                      <p>
                        <small className="text-muted">
                          <i className="fa fa-clock-o"></i> 11 hours ago via
                          Twitter
                        </small>
                      </p>
                    </div>
                  ...
                  <div className="timeline-panel">
                    ...
                    <div className="timeline-body">
                      <p>
                        ...
                        beatae consequuntur impedit nulla qui! Laborum, atque.
                      </p>
                      <hr />
                      <div className="btn-group">
                        <button
                  ...
                  <div className="timeline-panel">
                    ...
                    <div className="timeline-body">
                      <p>
                        ...
                        quas consequuntur nostrum sequi. Consequuntur, commodi.
                      </p>
                    </div>
                  </div>
                </li>
          ...
          <div className="chat-panel panel panel-default">
            <div className="panel-heading">
              ...
              <div className="btn-group pull-left">
                ...
                <ul className="dropdown-menu slidedown pull-left">
                  <li>
                    <a href="#">
              ...
              <ul className="chat">
                ...
                <li className="right clearfix">
                  <span className="chat-img pull-right">
                    <img
                      src="http://placehold.it/50/FA6F57/fff"
                      alt="User Avatar"
                      className="img-circle"
                    />
                  </span>
